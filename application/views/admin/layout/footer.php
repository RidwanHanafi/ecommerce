 ...
 <!-- Control Sidebar -->
  ...
  <!-- Main Footer -->
  <footer class="hapus-tombol main-footer">
    <!-- To the right -->
    <div class="float-right d-none d-sm-inline">
      Esthree Cake and Bakery
    </div>
    <!-- Default to the left -->
    <strong>Semoga hari ini berkah! &#128522; <!-- <a href="https://adminlte.io">AdminLTE.io</a> --></strong> 
  </footer>
</div>
<!-- ./wrapper -->
...
<!-- scriptku -->
<script src="<?php echo base_url() ?>assets/admin/scriptku/sweet.js"></script>
...
<script>
  ...
  $(function () {
    $("#button-print1").DataTable();
    $('#button-print2').DataTable({
      dom: 'Bfrtip',
          buttons: [{ extend: 'copy', className: 'btn btn-warning' },
...
<!-- JS untuk menampilkan nama gambar di upload -->
<script>
