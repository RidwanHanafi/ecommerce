...
if (isset($error)) {
  ...
  echo form_open_multipart(base_url('admin/konfigurasi/logo'), ' class="quick-example"');
?>
      ...
      <form role="form" >
        <div class="card">
          <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto text-center form p-4">
              ...
              <div class="form-group">
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" name="logo" value="<?php echo $konfigurasi->logo  ?>" required oninvalid="this.setCustomValidity('Upload Gambar Logo!')" oninput="setCustomValidity('')">
            ...
            <div class="col-sm-5">
              <img src="<?php echo base_url('assets/upload/image/logo/'.$konfigurasi->logo) ?>" class="img img-responsive img-thumbnail" width="150">
            </div>
          </div>
          <div class="row">
            <div class="col-sm-7">
